...
const barChart = new Chart(document.getElementById('canvas-2'), {
    ...
    data: {
        labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
        datasets: [{
                backgroundColor: 'rgba(220, 9, 9, 0.8)',
                borderColor: 'rgba(220, 9, 9, 0.8)',
                highlightFill: 'rgba(220, 9, 9, 0.8)',
                highlightStroke: 'rgba(220, 9, 9, 1)',
                data: [random(), random(), random(), random(), random(), random(), random()]
            },
            {
                backgroundColor: 'rgba(6, 165, 41, 0.8)',
                borderColor: 'rgba(6, 165, 41, 0.8)',
                highlightFill: 'rgba(6, 165, 41, 0.8)',
                highlightStroke: 'rgba(6, 165, 41, 1)',
                data: [random(), random(), random(), random(), random(), random(), random()]
            }
        ]
    },
